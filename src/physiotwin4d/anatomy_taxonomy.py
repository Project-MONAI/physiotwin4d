...
:class:`physiotwin4d.SegmentAnatomyBase` (which populates one via its
subclasses) and :class:`physiotwin4d.USDAnatomyTools` (which consumes one
...
class AnatomyTaxonomy:
    ...
    def group_for_label(self, label_name: str) -> str:
        ...
        keeps :class:`physiotwin4d.ConvertVTKToUSD` happy when it encounters
    ...
    def fill_other_group(
        ...
        Called by :class:`physiotwin4d.SegmentAnatomyBase` subclasses at the
