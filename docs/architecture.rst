...
``WorkflowConvertVTKToUSD``
   Converts in-memory PyVista/VTK meshes to animated USD scenes through the
   supported workflow wrapper. The lower-level :mod:`physiotwin4d.vtk_to_usd`
   package exposes advanced file conversion primitives.
